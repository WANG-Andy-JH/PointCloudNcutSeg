...
fpathlaz = "C:\Users\andy wong\Desktop\论文复现\ALS\ALS-on_BR04_2019-07-05_140m.laz";
fpath='Merge5.ply';
[ROI6,~,~,~] = pcdataread(fpath,1);
%% 验证数据
% fv1 = "C:\Users\andy wong\Desktop\论文复现\single_trees\PseMen_BR04_01\PseMen_BR04_01_2019-07-05_q2_ALS-on.laz";
% [pv1,~,~,~] = pcdataread(fv1,1);
% pcshow(pv1(:,1:3))
% fv2 =  "C:\Users\andy wong\Desktop\论文复现\single_trees\PseMen_BR04_02\PseMen_BR04_02_2019-07-05_q2_ALS-on.laz";
% fv3 = "C:\Users\andy wong\Desktop\论文复现\single_trees\PseMen_BR04_03\PseMen_BR04_03_2019-07-05_q2_ALS-on.laz";
% %% 范围内树的数量
% count = 0;
% for i=1:length(valData)
%     if (max(ROI6(:,1))>=valData(i,1)&&min(ROI6(:,1))<=valData(i,1)&& ...
%             max(ROI6(:,2))>=valData(i,2)&&min(ROI6(:,2))<=valData(i,2))
%         count=count+1;
%     end
% end
% maxX=max(ROI6(:,1))
